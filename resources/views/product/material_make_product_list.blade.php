...
<script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js"></script>
    ...
    <div class="row shadow rounded bg-light" style="padding-top:20px">
      ...
      <div class="col-md-2 text-right">
        <a style="font-size: 13px;" href="{{route('material.make.product')}}" class="btn btn-primary btn-rounded">Material  To Make Product</a>
...
<script type="text/javascript">
  $(function () {
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('materiak.make.product.data') }}",
        columns: [
